   ...
   <a class="navbar-brand mt-2 mt-lg-0" href="#">
    ...
    >
      ...
      <ul class="navbar-nav mb-2 mb-lg-0" style="margin-left: px;">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#"><i class="fa fa-home" aria-hidden="true"><div class="menu-items">Acceuil</div></i></a>
        </li>
        ...
        <li class="dropdown">
                ...
                <li>
                    ...
                    <a href="#" class="dropbtn"><i class="fa fa-truck" aria-hidden="true">
                            <div class="menu-items">
                                Exploitations
                            </div>
