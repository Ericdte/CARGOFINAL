...
<body>
    ...
    <div
        style="border:1px s black; border-style:groove; float:right; width:20%; height:650px; background-color:light-blue; margin-top:-450px;">
        <h6>Ajouter Une Etape de:</h6>


        <a href=" javascript:void(0)" class="add-more-form  btn btn-primary" style="margin-left: 5px;">CHARGEMENT</a>
