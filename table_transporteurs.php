...
$codep_transporteur = $_POST['codep_transporteur'];
...
`ville_transporteur`, `codep_transporteur`, `pay_transporteur`, `tel_transporteur`, `fax_transporteur`,
`email_transporteur`, `sw_transporteur` ) VALUES ('$tva_transporteur', '$nom_transporteur','$siret_transporteur',
'$rs_transporteur', '$ville_transporteur', '$codep_transporteur', '$pay_transporteur', '$tel_transporteur',
 ...
 <html>  
      ...
      <br /><br />  t
           <div class="container">  
                ...
                <br />  
                <button type="button" class="btn btn-primary" data-mdb-toggle="modal" data-mdb-target="#staticBackdrop">Créer Transporteur</button>  <br /><br/>
    ...
    <div class="modal-content">
      ...
      <form method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="siret_transporteur"
                                        autocomplete="off">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="codep _transporteur">
                                </div>
                                <div class="form-group">
                                    <label>Pay:</label>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
                                <label>TVA:</label>
                                    <input type="text" class="form-control" name="tva_transporteur" value=<?php echo $tva_transporteur;?>>
                                </div>
                                <div class="form-group">
                                    <label>Nom du Transporteur:</label>
                                    <input type="text" class="form-control" name="nom_transporteur" autocomplete="off" value=<?php echo $nom_transporteur;?>>
                                </div>
                                <div class="form-group">
                                    <label>Numero Siret:</label>
                                    <input type="text" class="form-control" name="siret_transporteur"
                                        autocomplete="off" value=<?php echo $siret_transporteur;?>>
                                </div>
                                <div class="form-group">
                                    <label>Raison Social:</label>
                                    <input type="text" class="form-control" name="rs_transporteur" autocomplete="off" value=<?php echo $rs_transporteur;?>>
                                </div>


                                <div class="form-group">
                                    <label>Ville:</label>
                                    <input type="text" class="form-control" name="ville_transporteur" value=<?php echo $ville_transporteur;?>>
                                </div>
                                <div class="form-group">
                                    <label>Code postal:</label>
                                    <input type="text" class="form-control" name="codep _transporteur" value=<?php echo $codep_transporteur;?>>
                                </div>
                                <div class="form-group">
                                    <label>Pay:</label>
                                    <input type="text" class="form-control" name="pay_transporteur" value=<?php echo $pay_transporteur;?>>
                                </div>
                                <div class="form-group">
                                    <label>Téléphone:</label>
                                    <input type="text" class="form-control" name="tel_transporteur" value=<?php echo $tel_transporteur;?>>
                                </div>
                                <div class="form-group">
                                    <label>Fax:</label>
                                    <input type="text" class="form-control" name="fax_transporteur" value=<?php echo $fax_transporteur;?>>
                                </div>


                                <div class="form-group">
                                    <label>Email:</label>
                                    <input type="text" class="form-control" name="email_transporteur" value=<?php echo $email_transporteur;?>>
                                </div>


                                <div class="form-group">
                                    <label>Site Web:</label>
                                    <input type="text" class="form-control" name="sw_transporteur" value=<?php echo $sw_transporteur;?>>
                                </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-mdb-dismiss="modal">Retour</button>
