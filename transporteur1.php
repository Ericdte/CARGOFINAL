...
<td>
<button class="btn btn-primary btn-small"><a href="update_transporteur.php? updateid='.$id.'" class="text-light">Modifier</a>
            </button>
<button class="btn btn-danger btn-small"><a href="pdf1.php? id='.$id.'"
                    class="text-light">Supprimer</a>
            </button>
            </td>
            </tr>
            </tr> ' ;
