...
$sql = "update `transporteur` set  id='$id', tva_transporteur='$tva_transporteur', nom_transporteur='$nom_transporteur',siret_transporteur='$siret_transporteur', rs_transporteur='$rs_transporteur', codep_transporteur='$codep_transporteur' pay_transporteur='$pay_transporteur',tel_transporteur='$tel_transporteur', fax_transporteur='$fax_transporteur', email_transporteur='$email_transporteur', sw_transporteur='$sw_transporteur' where id=$id";
$result=mysqli_query($con,$sql);
if ($result) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="codep_transporteur"
                                        value=<?php echo $codep_transporteur;?> </div>
                                    <div class="form-group">
                                        <label>Pay:</label>
